    ...
    return (
        <div className="page-bg">
            ...
            <section className="flex flex-col md:flex-row justify-between items-center px-4 md:px-[100px] py-8 md:py-[80px]">
                ...
                <img src={img25} alt="" className="w-[500px] md:max-w-none mt-6 md:mt-0" />
            </section>
            ...
            <section className="px-4 md:px-[100px] py-[60px]" style={{ borderTop: "1px solid var(--card-border)" }}>
                ...
                <div className="flex flex-col sm:grid sm:grid-cols-2 md:flex md:flex-row gap-[24px] pb-[40px]">
                    {[
                        { img: img26, time: "Завтрак • 230/250 гр", desc: "Утренний боул с перепелиным яйцом, киноа и лососем" },
                        { img: img27, time: "Обед • 320/30 гр", desc: "Боул с куриными фрикадельками в кунжуте, брокколи и миндальным соусом" },
                        { img: img28, time: "Полдник • 50/30 гр", desc: "Кукурузные блинчики с кокосовым припеком и фруктовым тар-таром" },
                        { img: img29, time: "Ужин • 100/100 гр", desc: "Морепродукты в соусе Гарсиа со стручковой фасолью" },
                    ].map((meal) => (
            ...
            {/* Боулы */}
            <section className="flex flex-col md:flex-row justify-between items-center px-4 md:px-[100px] py-[60px] gap-[40px]" style={{ borderTop: "1px solid var(--card-border)" }}>
                <div className="flex flex-col gap-[20px] w-full md:w-[600px]">
                    ...
                    <p className="text-[15px] text-muted leading-relaxed">
                        Боулы — это сбалансированный вариант блюда, содержащего в себе все необходимые элементы за счёт большого количества компонентов.
                    </p>
                    <p className="text-[15px] text-muted leading-relaxed">
                ...
                <div className="flex items-center gap-[16px]">
                    ...
                    <img src={img30} alt="" className="w-full max-w-[300px] md:max-w-none rounded-2xl" />
                    <button className="card w-[44px] h-[44px] rounded-full flex items-center justify-center text-[18px]" style={{ border: "1px solid var(--card-border)" }}>→</button>
                </div>
            </section>
            ...
            {/* Акции */}
            <section className="px-4 md:px-[100px] py-[60px]" style={{ borderTop: "1px solid var(--card-border)" }}>
                <h2 className="text-[28px] md:text-[40px] font-bold mb-8">Акции</h2>
                <div className="flex flex-col md:flex-row justify-between gap-6">
                    {[
                        { bg: "#EA9DA3" },
                        { bg: "#9898A0" },
                    ].map((promo, i) => (
                        <div key={i} className="rounded-[30px] w-full md:w-[550px] flex items-center justify-between p-[30px] text-white" style={{ backgroundColor: promo.bg }}>
                            <div>
                                <h3 className="font-bold text-[25px]">Наименование акции</h3>
                                <p className="py-[20px] opacity-90">Краткое описание акции</p>
                                <button className="py-[10px] px-[30px] rounded-[30px] border border-white hover:bg-white hover:text-black transition-colors">Подробнее</button>
                            </div>
                            <div className="w-[130px] h-[130px] rounded-full bg-white bg-opacity-20 flex-shrink-0"></div>
                        </div>
                    ))}
                </div>
            </section>
            ...
            {/* Отзывы */}
            <section className="px-4 md:px-[100px] py-[60px]" style={{ borderTop: "1px solid var(--card-border)" }}>
                <h2 className="text-[28px] md:text-[40px] font-bold mb-6">Отзывы</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:flex md:justify-between gap-4">
                    {[img31, img32, img33, img34].map((img, i) => (
                        <img key={i} src={img} alt="" className="w-full md:w-auto rounded-3xl" />
                    ))}
                </div>
            </section>

            {/* Пробный рацион */}
            <section className="px-4 md:px-[100px] py-[50px] flex flex-col md:flex-row justify-between items-center gap-8" style={{ borderTop: "1px solid var(--card-border)" }}>
                ...
                <img src={img35} alt="" className="w-[400px] md:max-w-none rounded-3xl" />
            </section>
